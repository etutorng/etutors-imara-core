...
export function DashboardClient() {
    ...
    const { t } = useLanguage();
    // Router no longer needed for auth redirect, but might be used for other navigation
    const router = useRouter();

    // Fallback name if session not fully loaded (though this component is rendered after server check)
